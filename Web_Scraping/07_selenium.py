...
# Yandex search bar ı bulmak (Full xpath yöntemi kullanılabilir)
...
WebDriverWait(driver, 4).until(expected_conditions.element_to_be_clickable((By.CSS_SELECTOR, ".search3__button."
